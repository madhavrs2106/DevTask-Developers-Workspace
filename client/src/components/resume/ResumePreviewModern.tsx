...
export function ResumePreviewModern({ data }: { data: ResumeData }) {
  ...
  return (
    <div
      id="resume-sheet"
      className="resume-print relative mx-auto w-full max-w-[820px] overflow-hidden bg-white text-slate-800 shadow-xl"
    ...
    >
      ...
      <div className="flex">
        ...
        <div className="w-1/3 space-y-5 border-r border-slate-200 bg-white p-6">
          {data.summary && (
            <section>
              <h2 className="mb-1.5 flex items-center gap-1.5 text-[11px] font-bold uppercase tracking-[0.12em] text-blue-800">
        ...
        <div className="w-2/3 space-y-5 p-6">
          {data.education.length > 0 && (
            <section>
              <h2 className="mb-2 text-[12px] font-bold uppercase tracking-[0.12em] text-blue-800">Education</h2>
          ...
          {data.experience.length > 0 && (
            <section>
              <h2 className="mb-2 text-[12px] font-bold uppercase tracking-[0.12em] text-blue-800">Experience</h2>
              <div className="relative space-y-3 border-l border-slate-300 pl-4">
          ...
          {data.projects.length > 0 && (
            <section>
              <h2 className="mb-2 text-[12px] font-bold uppercase tracking-[0.12em] text-blue-800">Projects</h2>
